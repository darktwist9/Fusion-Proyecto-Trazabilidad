@php
    ...
    $enCierre = ! $completado && (
        app(\App\Services\CierreEnvioPlantaMayoristaService::class)->tieneCondicionesVehiculo($ruta)
...
<div class="env-accion-cierre {{ ($conBordeSuperior ?? false) ? 'border-top pt-3 mt-3' : '' }}">
    <div class="env-accion-cierre__head">
        ...
        <div>
            ...
            <span class="small text-muted">Registre condiciones, llegada, incidentes y firmas del traslado.</span>
        </div>
    </div>
